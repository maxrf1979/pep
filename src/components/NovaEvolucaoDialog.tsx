...
import { AlertTriangle, Stethoscope, ClipboardPlus } from "lucide-react";
...
const buildSummary = (f: SoapForm) => {
  // 1ª linha do campo mais preenchido como resumo
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              {defaultPatientId ? (
                <div className={`${inp} border-border flex items-center text-foreground cursor-not-allowed opacity-70`}>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                {(
                  [
                    { key: "evolucao_medica", label: "Médica", Icon: Stethoscope },
                    { key: "evolucao_enfermagem", label: "Enfermagem", Icon: ClipboardPlus },
                  ] as const
                ).map(({ key, label, Icon }) => (
                  <button
                    key={key}
          ...
          {selectedPatient && selectedPatient.allergies.length > 0 && (
            <div className="flex items-center gap-2 px-3 py-2 rounded-md bg-destructive/5 border border-destructive/20 text-xs text-destructive">
              ...
              <span>
                <strong>Atenção — Alergias:</strong>{" "}
          ...
          <div>
            <div className="flex items-baseline gap-2 mb-1.5">
              ...
              <span className="text-xs text-muted-foreground">
                — exame físico e dados mensuráveis
              </span>
            </div>
            <textarea
              value={form.objetivo}
          ...
          <div>
            <div className="flex items-baseline gap-2 mb-1.5">
              ...
              <span className="text-xs text-muted-foreground">
                — conduta terapêutica e próximos passos
              </span>
            </div>
            <textarea
              value={form.plano}
