-- ========================================
-- SCRIPT PARA LIMPAR TUDO E RECRIAR
-- Sistema de Prontuário Eletrônico
-- ========================================

-- Passo 1: Remover TODAS as tabelas relacionadas a usuários
DROP TABLE IF EXISTS system_users CASCADE;
DROP TABLE IF EXISTS users CASCADE;
DROP TABLE IF EXISTS usuarios CASCADE;

-- Passo 2: Remover políticas antigas (se existirem)
DROP POLICY IF EXISTS "Permitir leitura de usuários do sistema" ON system_users;
DROP POLICY IF EXISTS "Permitir inserção apenas para admins" ON system_users;
DROP POLICY IF EXISTS "Permitir atualização apenas para admins" ON system_users;
DROP POLICY IF EXISTS "Permitir exclusão apenas para admins" ON system_users;

-- Passo 3: Criar tabela system_users com estrutura correta
...
SELECT
  'Tabela criada com sucesso!' as mensagem,
  COUNT(*) as total_usuarios
FROM system_users;

-- Passo 11: Mostrar todos os dados
SELECT
  id,
  username,
  name,
