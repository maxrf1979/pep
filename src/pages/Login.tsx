  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-background overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50 dark:bg-slate-950 relative">
        ...
        >
          <div className="bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl p-8 rounded-3xl border border-white/20 dark:border-slate-800/50 shadow-2xl relative group">
            {/* Logo Overlapping Box */}
            <div className="absolute -top-10 left-1/2 -translate-x-1/2 h-20 w-20 bg-primary rounded-xl flex items-center justify-center shadow-lg border-4 border-slate-50 dark:border-slate-900 overflow-hidden">
              {clinicData.logo ? (
